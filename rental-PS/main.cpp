...
int main()
{
    vector<string> aturan={"W","E","L","C","O","M","E"," ","T","O"," ","R","E","N","T","A","L"," ","P","S"};
    vector<float> beat={0.20,0.80,0.120,0.180,0.220,0.280,0.320,0.340,0.20,0.80,0.100,0.20,0.80,0.120,0.180,0.220,0.280,0.300,0.20,0.180};
    cout<<"+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+"<<endl;
    cout<<"\t\t";
    for(int i=0; i<aturan.size(); i++){
        cout<<aturan[i];
        usleep(beat[i]*1000000);
    }
    cout<<"\t\t"<<endl;
    cout<<endl;
